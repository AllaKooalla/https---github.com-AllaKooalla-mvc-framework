                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_description[1][title]" class="form-control" id="title"
                                placeholder="Наименование категории"
                                value="<?= get_field_array_value('category_description', '1', 'title') ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="description">Мета-описание</label>
                            <input type="text" name="category_description[1][description]" class="form-control"
                                id="description" placeholder="Мета-описание"
                                value="<?= get_field_array_value('category_description', '1', 'description') ?>">
                        </div>

                        <div class="form-group">
                            <label for="keywords">Ключевые слова</label>
                            <input type="text" name="category_description[1][keywords]" class="form-control"
                                id="keywords" placeholder="Ключевые слова"
                                value="<?= get_field_array_value('category_description', '1', 'keywords') ?>">
                        </div>

                        <div class="form-group">
                            <label for="content">Описание категории</label>
                            <textarea name="category_description[1][content]" class="form-control editor" id="content"
                                rows="3"
                                placeholder="Описание категории"><?= get_field_array_value('category_description', '1', 'content') ?></textarea>
                        </div>

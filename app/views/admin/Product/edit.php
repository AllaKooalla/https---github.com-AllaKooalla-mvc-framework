                ...
                <div class="card-body">
                    <div class="tab-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description['1'][title]"
                                           class="form-control" id="title" placeholder="Наименование товара"
                                           value="<?= h($product['1']['title']) ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description['1'][description]"
                                           ...
                                           value="<?= h($product['1']['description']) ?>">
                                </div>

                                <div class="form-group">
                                    <label for="keywords">Ключевые слова</label>
                                    <input type="text" name="product_description['1'][keywords]"
                                           class="form-control" id="keywords" placeholder="Ключевые слова"
                                           value="<?= h($product['1']['keywords']) ?>">
                                </div>

                                <div class="form-group">
                                    <label for="exerpt" class="required">Краткое описание</label>
                                    <input type="text" name="product_description['1'][exerpt]"
                                           class="form-control" id="exerpt" placeholder="Краткое описание"
                                           value="<?= h($product['1']['exerpt']) ?>">
                                </div>

                                <div class="form-group">
                                    <label for="content">Описание товара</label>
                                    <textarea name="product_description['1'][content]"
                                              class="form-control editor" id="content" rows="3"
                                              placeholder="Описание товара"><?= h($product['1']['content']) ?></textarea>
                                </div>
